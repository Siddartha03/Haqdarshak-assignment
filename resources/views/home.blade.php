<html lsng="en" dir="ltr">
 ...
 <body onload="startSlide2()">
    ...
    <div class="sidebar">
        <img class="image" src="images/new-accout.png" alt="user photo"><header>User photo</header>
        <ul>
            <li><a href="home"><i class="fa fa-home"></i>Home</a></li>
            <li><a href="signup"><i class="fas fa-rupee-sign"></i>Get Cash</a></li>
            <li><a href="signup"><i class="fas fa-user"></i>Profile</a></li>
            <li><a href="signup"><i class="fas fa-sign-out-alt"></i>SignUp/SignIn</a></li>
        </ul>
    </div>
    <section>
    <h1>Pocket Cash</h1>
